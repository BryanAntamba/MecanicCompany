// navbarMecanico.ts
// Estilos de la barra de navegación del panel mecánico (NavbarMecanico).
// Mismo diseño que navbarAdmin
...
export default StyleSheet.create({
  ...
  // Contenedor del logo + texto "PANEL MECÁNICO" en fila horizontal
  navBrandGroup: {
    flexDirection: 'row',
    alignItems: 'center',        // Centra verticalmente el logo y el texto
  },

  // Texto "PANEL MECÁNICO" junto al logo
  navBrand: {
