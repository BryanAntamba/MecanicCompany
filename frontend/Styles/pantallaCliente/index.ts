...
export default StyleSheet.create({
  ...
  videoBgIcon: {
    width: 260,
    height: 260,
    marginTop: 40,            // Baja la imagen para que no esté muy arriba
    marginBottom: 20,         // Menos separación para que el subtítulo esté más pegado
  },
  ...
  videoBgSubtitle: {
    width: '92%',
    height: 140,
    marginBottom: 10,         // Menos separación para que esté más arriba
  },
  ...
  aboutArrow: {
    ...
    alignSelf: 'center',     // Alinea la flecha al centro verticalmente
    zIndex: 1,               // Por debajo del navbar (navbar tiene zIndex 10000)
  },
  ...
  // --- SECCIÓN GOOGLE MAPS ---
  mapSection: {
    marginTop: 40,         // Separación del formulario
    marginBottom: 50,      // Separación mayor del footer (antes era 0 implícito)
    paddingHorizontal: 16,
    paddingVertical: 24,
    backgroundColor: '#111827',
    borderRadius: 20,
  ...
  // --- ESTILOS PARA TÍTULOS Y AYUDAS DE CAMPOS ---
  fieldLabel: {
    color: '#E2E8F0',
    fontSize: 14,
    fontWeight: '600',
  ...
  // MapView para mostrar ubicación
  mapView: {
    width: '100%',
    height: 250,
    borderRadius: 16,
