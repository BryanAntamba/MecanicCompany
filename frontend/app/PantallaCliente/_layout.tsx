// Componente Tabs de Expo Router: define la navegación por pestañas del grupo PantallaCliente
import { Tabs } from 'expo-router';

// React es necesario para que JSX funcione correctamente en este archivo
import React from 'react';

// Layout del grupo PantallaCliente: configura la barra de pestañas para todas las pantallas del grupo
export default function TabLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="index"                     // Nombre de la ruta (corresponde a app/PantallaCliente/index.tsx)
